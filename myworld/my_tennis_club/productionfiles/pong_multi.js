...
let paddle_3 = document.querySelector('.paddle_3');
let paddle_4 = document.querySelector('.paddle_4');
let board = document.querySelector('.board');
let initial_ball = document.querySelector('.ball');
let ball = document.querySelector('.ball');
let score_1 = document.querySelector('.player_1-3_score');
let score_2 = document.querySelector('.player_2-4_score');
let message = document.querySelector('.message');
let paddle_1_coord = paddle_1.getBoundingClientRect();
let paddle_2_coord = paddle_2.getBoundingClientRect();
let paddle_3_coord = paddle_3.getBoundingClientRect();
let paddle_4_coord = paddle_4.getBoundingClientRect();
...
if (gameState == 'play') {
    ...
    if (e.key == '\'') {
        paddle_4.style.top =
            Math.max(
            board_coord.top,
            paddle_4_coord.top - window.innerHeight * 0.1
            ) + 'px';
